[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_clipboard/raw/main/dist/nv_clipboard_v5.0.2.pyzw)
...
Download the latest release [nv_clipboard_v5.0.2.pyzw](https://github.com/peter88213/nv_clipboard/raw/main/dist/nv_clipboard_v5.0.2.pyzw)

- Launch *nv_clipboard_v5.0.2.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_clipboard_v5.0.2.pyzw` (Windows), resp. `python3 nv_clipboard_v5.0.2.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [nv_clipboard_v5.0.2.zip](https://github.com/peter88213/nv_clipboard/raw/main/dist/nv_clipboard_v5.0.2.zip)

- Extract the *nv_clipboard_v5.0.2* folder from the downloaded zipfile "nv_clipboard_v5.0.2.zip".
