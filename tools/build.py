...
SOURCE_DIR = '../src/'
TEST_DIR = '../test/'
SOURCE_FILE = f'{SOURCE_DIR}nv_clipboard.py'
TEST_FILE = f'{TEST_DIR}nv_clipboard.py'
NVLIB = 'nvlib'
...
def inline_modules():
    inliner.run(SOURCE_FILE, TEST_FILE, 'nvclipboardlib', '../../nv_clipboard/src/')
